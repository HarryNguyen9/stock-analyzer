export const MAX_HISTORICAL_CANDLES = 365;
export const DEFAULT_DETAIL_CANDLE_LIMIT = MAX_HISTORICAL_CANDLES;
export const DEFAULT_BACKFILL_TARGET_CANDLES = MAX_HISTORICAL_CANDLES;

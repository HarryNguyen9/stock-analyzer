export const vi = {
  ...
  home: {
    ...
    scannerGroups: {
      ...
      breakout: "Breakout",
      volumeSpike: "Volume đột biến",
      oversoldRsi: "RSI quá bán",
      strongTrend: "Xu hướng tăng mạnh",
    ...
    notifications: {
      ...
      open: "Mở thông báo",
      close: "Đóng",
      emptyTitle: "Chưa có tín hiệu đáng chú ý",
      emptyDescription: "Các tín hiệu yếu hoặc lặp lại trong ngày sẽ được ẩn bớt.",
      count: (count: number) => `${count} tín hiệu`,
      tabs: {
        all: "Tất cả",
        bullish: "Tích cực",
        risk: "Rủi ro",
  ...
  stock: {
    ...
    refresh: {
      ...
      stale: "Dữ liệu đã cũ, app sẽ làm mới riêng mã này trong nền.",

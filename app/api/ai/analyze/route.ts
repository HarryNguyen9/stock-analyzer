...
async function createAiInput(
  ...
  return {
    ...
    advancedIndicators: {
      ema20: snapshot.analysis.indicators.ema20,
      ema50: snapshot.analysis.indicators.ema50,
      ema200: snapshot.analysis.indicators.ema200,
      macd: snapshot.analysis.indicators.macd,
      adx14: snapshot.analysis.indicators.adx14,
      obv: snapshot.analysis.indicators.obv,
      stochasticRsi: snapshot.analysis.indicators.stochasticRsi,
      bollingerBands20: snapshot.analysis.indicators.bollingerBands20,
      atr14: snapshot.analysis.indicators.atr14,
    },
    supportResistance: snapshot.analysis.supportResistance,
    methodSummaries: snapshot.analysis.methodSummaries.map((summary) => ({
      key: summary.key,
    ...
    priceAction: snapshot.analysis.priceAction,

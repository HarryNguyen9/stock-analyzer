...
export function StockSearchList({
  ...
  return (
    <section className="mx-auto w-full max-w-7xl overflow-x-hidden px-4 py-6 sm:px-6 lg:px-8">
      <div className="sticky top-0 z-10 border-b border-slate-200 bg-slate-50/95 pb-4 pt-2 backdrop-blur dark:border-slate-800 dark:bg-slate-950/90 sm:static sm:border-0 sm:bg-transparent sm:pb-0 sm:pt-0 sm:dark:bg-transparent">
